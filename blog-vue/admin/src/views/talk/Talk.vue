    ...
    <div class="talk-container">
      ...
      <div class="operation-wrapper">
          ...
          <el-popover placement="bottom-start" width="460" trigger="click">
            <span class="emoji-item" v-for="(value, key, index) of emojiList" :key="index" @click="addEmoji(key, value)">
              <!-- <img
                ...
                height="24"
              /> -->
              <span class="emoji" :title="key">{{ value }}</span>
            </span>
            <i class="iconfont el-icon-mybiaoqing operation-btn" slot="reference" />
          </el-popover>
          <!-- 图片上传 -->
          <el-upload action="/api/admin/talks/images" multiple :before-upload="beforeUpload" :on-success="upload"
        ...
        <div class="right-wrapper">
          <!-- 是否置顶 -->
          <el-switch style="margin-right:16px" v-model="talk.isTop" inactive-text="置顶" :active-value="1"
            :inactive-value="0" />
          <!-- 说说状态 -->
      ...
      <!-- 图片上传 -->
      <el-upload class="talk-image-upload" v-show="uploadList.length > 0" action="/api/admin/talks/images"
        list-type="picture-card" :file-list="uploadList" multiple :before-upload="beforeUpload" :on-success="upload"
...
import EmojiList from "../../assets/js/emojiall";
